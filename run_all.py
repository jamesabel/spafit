...
def main():
    if spafit.is_mac():
        ...
        subprocess.check_call('./test_cx_freeze_mac.sh', cwd='test_cx_freeze_mac', shell=True)
        ...
        subprocess.check_call('test_py2exe_win.bat', cwd='test_py2exe_win', shell=True)
        subprocess.check_call('test_pyinstaller_win.bat', cwd='test_pyinstaller_win', shell=True)
        subprocess.check_call('test_pynsist_win.bat', cwd='test_pynsist_win', shell=True)
